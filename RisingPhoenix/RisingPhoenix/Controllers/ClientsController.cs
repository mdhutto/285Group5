...
namespace RisingPhoenix.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ClientsController(RisingPhoenixDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ClientId,ClientName,ClientPhone,ClientEmail")] Clients clients)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClientId,ClientName,ClientPhone,ClientEmail")] Clients clients)
        {
